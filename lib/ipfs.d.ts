...
// // stolen from https://github.com/beenotung/typestub-ipfs/blob/master/index.d.ts
...
//     subscribe(topic: string, handler: (event: PubsubEvent) => any, options: any, callback: Callback<any>): void;
//     subscribe(topic: string, handler: (event: PubsubEvent) => any, options: any): Promise<void>;

//     unsubscribe(topic: string, handler: (event: PubsubEvent) => any, callback: Callback<void>): void;
//     unsubscribe(topic: string, handler: (event: PubsubEvent) => any): Promise<void>;

//     publish(topic: string, data: Buffer | Uint8Array, callback: Callback<any>): void;
//     publish(topic: string, data: Buffer | Uint8Array): Promise<any>;

//     ls(callback: Callback<any>): void;
//     ls(): Promise<any>;

//     peers(topic: string, callback: Callback<any>): void;
//     peers(topic: string): Promise<any>;
